...
--pgsqlds3_cleanup_large.sql: cleans up new users and orders; restart pgsql after running to reset Identity columns
...
delete from REVIEWS where REVIEW_ID > 20000000;
delete from REVIEWS_HELPFULNES where REVIEW_HELPFULNES_ID > 20000000;
delete from MEMBERSHIP where CUSTOMERID > 2000000;
