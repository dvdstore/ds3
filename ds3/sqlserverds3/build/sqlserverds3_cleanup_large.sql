...
--sqlserverds3_cleanup_large.sql: cleans up new users and orders and resets IDENTITY columns; reloads INV and re-creates trigger; cleans reorder table
...
go
delete from REVIEWS where REVIEWID > 20000000
go
...
go
dbcc checkident('REVIEWS', RESEED, 20000000)
go
