...
--sqlserverds3_cleanup_small.sql: cleans up new users, orders, and reviews and resets IDENTITY columns; reloads INV and re-creates trigger; cleans reorder table
...
go
delete from REVIEWS where REVIEWID > 200000
go
