...
-- sqlserverds3_load_cust.sql

use DS3
go
alter database DS3 set recovery bulk_logged
go
bulk insert CUSTOMERS from '{DRIVELETTER}:\ds3\data_files\cust\us_cust.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUSTOMERS from '{DRIVELETTER}:\ds3\data_files\cust\row_cust.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
...
set dateformat ymd
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\jan_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\feb_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\mar_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\apr_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\may_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\jun_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\jul_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\aug_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\sep_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\oct_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\nov_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds3\data_files\orders\dec_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_orderlines.sql

bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\jan_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\feb_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\mar_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\apr_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\may_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\jun_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\jul_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\aug_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\sep_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\oct_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\nov_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds3\data_files\orders\dec_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_cust_hist.sql

bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\jan_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\feb_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\mar_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\apr_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\may_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\jun_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\jul_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\aug_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\sep_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\oct_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\nov_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds3\data_files\orders\dec_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_prod.sql

bulk insert PRODUCTS from '{DRIVELETTER}:\ds3\data_files\prod\prod.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_inv.sql

bulk insert INVENTORY from '{DRIVELETTER}:\ds3\data_files\prod\inv.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_memebership.sql

bulk insert MEMBERSHIP from '{DRIVELETTER}:\ds3\data_files\membership\membership.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds3_load_reviews.sql

bulk insert REVIEWS from '{DRIVELETTER}:\ds3\data_files\reviews\reviews.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert REVIEWS_HELPFULNESS from '{DRIVELETTER}:\ds3\data_files\reviews\review_helpfulness.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
...
EXEC sp_fulltext_catalog  'FULLTEXTCAT_DSPROD', 'create', '{FULLTEXTCAT_PATH}'
